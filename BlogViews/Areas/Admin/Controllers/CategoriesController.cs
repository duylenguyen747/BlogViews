...
namespace BlogViews.Areas.Admin.Controllers
{
	...
	public class CategoriesController : Controller
	{
		...
		public async Task<IActionResult> Create([Bind("CatId,CatName,Title,Alias,MetaDesc,MetaKey,Thumb,Publisher,Ordering,Parents,Levels,Icon,Cover,Description")] Category category)
		{
		...
		[HttpPost]
		[ValidateAntiForgeryToken]
		public async Task<IActionResult> Edit(int id, [Bind("CatId,CatName,Title,Alias,MetaDesc,MetaKey,Thumb,Publisher,Ordering,Parents,Levels,Icon,Cover,Description")] Category category)
		{
